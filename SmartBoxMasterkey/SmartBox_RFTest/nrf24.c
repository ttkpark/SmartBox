...
volatile uint8_t nrf24_dataReady() 
{
    // See note in getData() function - just checking RX_DR isn't good enough
    volatile uint8_t __Status = nrf24_getStatus();
...
volatile uint8_t nrf24_getStatus()
{
    uint8_t rv;
    nrf24_csn_digitalWrite(LOW);
    rv = spi_transfer(NOP);
...
static const char * const rf24_datarate_e_str_P[] = {"1MBPS","2MBPS","250KBPS"};
static const char * const rf24_model_e_str_P[] = {"nRF24L01","nRF24L01+"};
static const char * const rf24_crclength_e_str_P[] = {"Disabled","8 bits","16 bits"};
static const char * const rf24_pa_dbm_e_str_P[] = { "PA_MIN","PA_LOW","LA_MED","PA_HIGH"};
